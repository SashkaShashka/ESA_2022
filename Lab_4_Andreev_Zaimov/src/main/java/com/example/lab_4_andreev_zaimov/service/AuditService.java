...
import com.example.lab_4_andreev_zaimov.model.Mappable;
...
public class AuditService {
    ...
    public void log(Mappable objectOld, Mappable objectNew, String table, String eventType) {
        ...
        for (Object key : objectOld.toMap().keySet()) {
            mergedData.put(key + "_old", oldData.get((String) key));
            mergedData.put(key + "_new", newData.get((String) key));
        }
